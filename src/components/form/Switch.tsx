...
/**
 * Renders a switch-style checkbox with no form instance backing it.
 *
 * @param checked defines whether the checkbox behind this switch is checked or not
 * @param label label of the input
 * @param id ID of the input
 * @param onClick additional logic to be executed when the switch is clicked
 */
export const UnboundSwitch = ({ checked, label, id, onClick }: UnboundSwitchProps): ReactNode => {
